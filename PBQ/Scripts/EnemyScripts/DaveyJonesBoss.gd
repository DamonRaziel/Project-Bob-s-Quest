...
var enemy_fort = 10
var enemy_lightning_res = 0
var enemy_ice_res = 10
var enemy_fire_res = 0
var enemy_earth_res = 0
	...
	if is_attacking_player == true:
		if attacking == true:
			if attack == 1:
				...
				get_node("AnimationTreePlayer").oneshot_node_start("DJOneShot")
			elif attack == 2:
				get_node("AnimationTreePlayer").blend3_node_set_amount("DJAttackBlend", 0)
				get_node("AnimationTreePlayer").oneshot_node_start("DJOneShot")
			elif attack == 3:
				get_node("AnimationTreePlayer").blend3_node_set_amount("DJAttackBlend", 1)
				get_node("AnimationTreePlayer").oneshot_node_start("DJOneShot")
