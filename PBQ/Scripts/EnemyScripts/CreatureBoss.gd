...
var enemy_fort = 10
var enemy_lightning_res = 7
var enemy_ice_res = 7
var enemy_fire_res = 7
var enemy_earth_res = 7
	...
	if can_attack_timer >=can_attack_time:
		if is_attacking_player:
			if attack_timer>=attack_time:
				...
				attacking = true
				if attack == 1:
					boss_creature_attack1()
				elif attack == 2:
					boss_creature_attack2()
				elif attack == 3:
					boss_creature_attack3()
				elif attack == 4:
					boss_creature_attack4()
				elif attack == 5:
					boss_creature_attack5()
				elif attack == 6:
					boss_creature_attack6()
				#6 attacks, 3 hand, 3 wings
				#see if can separate animation players for animations and more move and attack controls
	else:
		attacking = false
	var speed 
	...
	if is_attacking_player == true:
		if attacking == true:
			if attack == 1:
				...
				get_node("AnimationTreePlayer").blend3_node_set_amount("WingsAttackBlend", -1)
				get_node("AnimationTreePlayer").blend2_node_set_amount("AttackBlend", 1)
				get_node("AnimationTreePlayer").oneshot_node_start("AttackOneShot")
			elif attack == 5:
				get_node("AnimationTreePlayer").blend3_node_set_amount("WingsAttackBlend", 0)
				get_node("AnimationTreePlayer").blend2_node_set_amount("AttackBlend", 1)
				get_node("AnimationTreePlayer").oneshot_node_start("AttackOneShot")
			elif attack == 6:
				get_node("AnimationTreePlayer").blend3_node_set_amount("WingsAttackBlend", 1)
