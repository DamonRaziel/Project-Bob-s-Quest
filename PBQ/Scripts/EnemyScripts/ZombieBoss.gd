...
func _physics_process(delta):
	...
	if is_attacking_player == true:
		if attacking == true:
			if attack == 1:
				get_node("AnimationTreePlayer").blend3_node_set_amount("ZAttackBlend", -1)
				get_node("AnimationTreePlayer").oneshot_node_start("ZOneShot")
			elif attack == 2:
				get_node("AnimationTreePlayer").blend3_node_set_amount("ZAttackBlend", 0)
				get_node("AnimationTreePlayer").oneshot_node_start("ZOneShot")
			elif attack == 3:
				get_node("AnimationTreePlayer").blend3_node_set_amount("ZAttackBlend", 1)
				get_node("AnimationTreePlayer").oneshot_node_start("ZOneShot")

func zombie_boss_attack1():
	var area = $Area
...
func zombie_die():
	...
	PlayerData.Player_Information.beaten_zombie_boss = true
	queue_free()
