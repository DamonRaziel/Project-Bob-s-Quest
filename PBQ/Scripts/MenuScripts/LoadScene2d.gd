...
func _on_DeleteButton1_pressed():
	Global_Player.delete_file_01()
	reload_save_files()

func _on_DeleteButton2_pressed():
	Global_Player.delete_file_02()
	reload_save_files()

func _on_DeleteButton3_pressed():
	Global_Player.delete_file_03()
	reload_save_files()

func _on_DeleteButton4_pressed():
	Global_Player.delete_file_04()
	reload_save_files()
