...
Project Bob's Quest is designed to be a 3D action/adventure/platform/RPG game. Version 1 does not have the RPG element.

Project Bob's Quest was made combining aspects from a number of other projects, such as the inventory and camera controls, the Godot demo templates, and some problem-solving of my own to figure out how things could be done.
